...
const questions = [
  ...
  {
    question: "Volumul unei colectivitati generale este N = 500. Stiind ca se formeaza din colectivitatea generala esantioane de volum n=60, care este pasul de esantionare k? (I 81)",
    answers: [
      { text: "a) k=9", correct: false },
      { text: "b) k=8", correct: true },
      { text: "c) k=7", correct: false },
      { text: "d) k=10", correct: false },
    ],
  },
  {
    question: "Care dintre metodele de observare statistica este totala, periodica, directa si statica? (I 82)",
    answers: [
      { text: "a) recensamantul", correct: true },
      { text: "b) sondajul statistic", correct: false },
      { text: "c) ancheta statistica", correct: false },
      { text: "d) raportul statistic", correct: false },
    ],
  },
  {
    question: "Se considera urmatoarele exemple de variabile statistice: temperatura, felul profesiei, greutatea, starea de sanatate, inaltimea, statutul marital, genul unei persoane, codul PIN al unui card. Care din urmatoarele afirmatii este adevarata: (I 83)",
    answers: [
      { text: "a) temperatura si felul profesiei sunt insumabile direct", correct: false },
      { text: "b) felul profesiei, statutul marital si codul PIN sunt insumabile direct", correct: false },
      { text: "c) inaltimea si greutatea sunt insumabile direct", correct: true },
      { text: "d) starea de sanatate si genul sunt insumabile direct", correct: false },
    ],
  },
  {
    question: "Formula lui H.A. Sturges se utilizeaza in: (I 84)",
    answers: [
      { text: "a) gruparea simpla pe variante", correct: false },
      { text: "b) gruparea simpla pe intervale de variatie egale", correct: true },
      { text: "c) gruparea simpla pe intervale de variatie inegale", correct: false },
      { text: "d) gruparea combinata", correct: false },
    ],
  },
  {
    question: "Care dintre marimile relative K A/B, K B/A, K t/0, K t/t-1, k pl/0, K 1/pl si K 1/0 sunt marimi relative ale dinamicii? (I 85)",
    answers: [
      { text: "a) K A/B si K B/A", correct: false },
      { text: "b) K pl/0 si K 1/pl", correct: false },
      { text: "c) K 1/0 si K t/0", correct: false },
      { text: "d) K t/t-1 si K t/0", correct: true },
    ],
  },
  {
    question: "Un studiu privind populatia statistica a firmelor situate intr-un anumit spatiu economic, din punctul de vedere al profitului anual, exprimat in milioane lei, a furnizat urmatoarea repartitie de frecvente a unei selectii de volum 200: (20-24/20 24-28/35 28-32/40 32-36/60 36-40/32 40-44/8 44-48/5) Fie S= x + Mo-Me. Atunci: (I 80)",
    answers: [
      { text: "a) S= 34,16 ", correct: false },
      { text: "b) S= 33", correct: false },
      { text: "c) S= 34", correct: false },
      { text: "d) S= 33,16", correct: true },
    ],
  },
  {
    question: "Media, mediana si modul sunt indicatori: (I 87)",
    answers: [
      { text: "a) de nivel si de frecvente", correct: false },
      { text: "b) a tendintei centrale", correct: true },
      { text: "c) de variatie", correct: false },
      { text: "d) de asimetrie si aplatizare", correct: false },
    ],
  },
  {
    question: "Dintr-o populatie statistica formata din angajatii unui supermarket se extrage o selectie aleatoare de volum 10 si se evalueaza simultan numarul orelor lucrate si salariul net lunar, obtinandu-se urmatorul tabel (vezi carte pentru tabel). Daca r este coeficientul de corelatie dintre orele lucrate si salariul net lunar, atunci: (I 88)",
    answers: [
      { text: "a) r= 0,873", correct: false },
      { text: "b) r= 0,476", correct: false },
      { text: "c) r= 0,981", correct: true },
      { text: "d) r= 0,215", correct: false },
    ],
  },
  {
    question: "La o unitate hoteliera s-a inregistrat urmatoarea informatie cu privire la repartitia turistilor in functie de durata sejurului: (vezi carte pentru tabel). Atunci coeficientul de variatie v este: (I 89)",
    answers: [
      { text: "a) v= 23,7%", correct: true },
      { text: "b) v= 36,1%", correct: false },
      { text: "c) v= 50,3%", correct: false },
      { text: "d) v= 45,2%", correct: false },
    ],
  },
  {
    question: "Se cunosc urmatoarele serii de repartitie cu frecvente absolute si respectiv relative, cu intervale egale si respectiv neegale, referitoare la aceeasi colectivitate: (vezi carte pentru tabel). Care dintre cele doua serii este mai omogena? (I 90)",
    answers: [
      { text: "a) ambele serii au aceeasi omogenitate <35%", correct: false },
      { text: "b) ambele serii au aceeasi omogenitate >35%", correct: false },
      { text: "c) seria (1)", correct: true },
      { text: "d) seria (2)", correct: false },
    ],
  },
  {
    question: "Evolutia profitului la o societate comerciala pe primele 9 luni ale anului trecut se prezinta in urmatorul tabel: (vezi carte pentru tabel). Care din urmatoarele afirmatii este adevarata? (I 91)",
    answers: [
      { text: "a) fata de luna ianuarie profitul a crescut sistematic, ajungand la o crestere de 630 mil. lei in luna septembrie", correct: false },
      { text: "b) in luna aprilie profitul a sporit fata de luna martie cu 70 mil. lei", correct: false },
      { text: "c) indicele de dinamica cu baza fixa corespunzator lunii mai: I 5/1 = 1,1%", correct: false },
      { text: "d) ritmul de dinamica cu baza in lant corespunzator lunii iunie: R 6/5 = 5,8%", correct: true },
    ],
  },
  {
    question: "Evolutia profitului la o societate comerciala pe primele 8 luni ale anului trecut se prezinta in urmatorul tabel: (vezi carte pentru tabel). Dupa determinarea trendului prin metoda ajustarii liniare, care este estimarea profitului pentru luna septembrie? (I 92)",
    answers: [
      { text: "a) 1946,85 mil lei", correct: true },
      { text: "b) 1846,85 mil lei", correct: false },
      { text: "c) 1900 mil lei", correct: false },
      { text: "d) 1700 mil lei", correct: false },
    ],
  },
  {
    question: "Cu privire la activitatea unei societati comerciale se cunosc urmatoarele date: (vezi carte pentru tabel). Stiind ca in anul 1999 valoarea absoluta a incasarilor a fost de 25 mld. lei, valoarea absoluta a incasarilor din anul 2001 este: (I 93)",
    answers: [
      { text: "a) 119,2 mld. lei ", correct: false },
      { text: "b) 120,1 mld. lei", correct: true },
      { text: "c) 121,3 mld. lei", correct: false },
      { text: "d) 118 mld. lei", correct: false },
    ],
  },
  {
    question: "Cu privire la activitatea unei societati comerciale se cunosc urmatoarele date: (vezi carte pentru tabel). Dupa determinarea trendului prin metoda ajustarii liniare, care este estimarea modificarii in anul 2005 fata de 2004? (I 94)",
    answers: [
      { text: "a) 2,5", correct: false },
      { text: "b) 2,9", correct: false },
      { text: "c) 3,2", correct: true },
      { text: "d) 3,5", correct: false },
    ],
  },
  {
    question: "Volumul unei colectivitati generale este N=600. Stiind ca se formeaza din colectivitatea generala esantioane de volum n=50, care este pasul de esantionare k? (I 95)",
    answers: [
      { text: "a) k = 9", correct: false },
      { text: "b) k = 8", correct: false },
      { text: "c) k = 12", correct: true },
      { text: "d) k = 10", correct: false },
    ],
  },
  {
    question: "Cu privire la activitatea unei societati comerciale se cunosc urmatoarele date: (vezi carte pentru tabel). Stiind ca in anul 2000 valoare absoluta a incasarilor a fost de 30 mld. lei, valoare absoluta a incasarilor din anul 2002 este: (I 96)",
    answers: [
      { text: "a) 190,2 mld. lei", correct: false },
      { text: "b) 198 mld. lei", correct: true },
      { text: "c) 200,1 mld. lei", correct: false },
      { text: "d) 218 mld. lei", correct: false },
    ],
  },
  {
    question: "Evolutia profitului la o societate comerciala pe primele 8 luni ale anului trecut se prezinta in urmatorul tabel: (vezi carte pentru tabel). Dupa determinarea trendului prin metoda ajustarii liniare, care este estimarea profitului pentru luna septembrie? (I 97)",
    answers: [
      { text: "a) 1907,13", correct: true },
      { text: "b) 2000", correct: false },
      { text: "c) 2003", correct: false },
      { text: "d) 1850,45", correct: false },
    ],
  },
  {
    question: "Dintr-o populatie statistica formata din angajatii unui supermarket se extrage o selectie aleatoare de volum 11 si se evalueaza simultan numarul orelor lucrate si salariul net lunar, obtinandu-se urmatorul tabel: (vezi carte pentru tabel). Daca r este coeficientul de corelatie dintre orele lucrate si salariul net lunar, atunci: (I 98)",
    answers: [
      { text: "a) r = 0,8", correct: false },
      { text: "b) r = 0,981", correct: true },
      { text: "c) r = 0,476", correct: false },
      { text: "d) r = 0,21", correct: false },
    ],
  },
  {
    question: "La o unitate hoteliera s-a inregistrat urmatoarea informatie cu privire la repartitia turistilor in functie de durata sejurului: (vezi carte pentru tabel). Atunci coeficientul variatiei v este: (I 99)",
    answers: [
      { text: "a) 20%", correct: false },
      { text: "b) 22,2%", correct: false },
      { text: "c) 39,1%", correct: false },
      { text: "d) 26%", correct: true },
    ],
  },
  {
    question: "La o unitate hoteliera s-au inregistrat urmatoarele date: (vezi carte pentru tabel). Dupa determinarea trendului prin metoda adjustarii liniare, care este estimarea volumului incasarilor pentru luna august? (I 100)",
    answers: [
      { text: "a) 1000", correct: false },
      { text: "b) 750,15", correct: false },
      { text: "c) 947,14", correct: true },
      { text: "d) 990,55", correct: false },
    ],
  },
  {
